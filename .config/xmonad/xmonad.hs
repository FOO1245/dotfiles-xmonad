...
clipboardy = spawn "rofi -no-lazy-grab -modi \"clipboard:greenclip print\" -show clipboard -run-command '{cmd}' -theme ~/.config/rofi/launcher/style.rasi"

centerlaunch = spawn "exec eww open-many blur_full weather profile quote search_full incognito-icon vpn-icon home_dir screenshot power_full reboot_full lock_full logout_full suspend_full"
...
rofiLauncher = spawn "rofi -no-lazy-grab -show drun -modi run,drun,window -theme ~/.config/rofi/launcher/style.rasi"
...
myKeys conf@XConfig {XMonad.modMask = modm} = M.fromList $
    ...
    , ((modm,               xK_z     ), spawn "exec ~/.config/scripts/inhibit_activate")
    , ((modm .|. shiftMask, xK_z     ), spawn "exec ~/.config/scripts/inhibit_deactivate")
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,15), (R,15), (U,35), (D,10)]) -- reset the GapSpec
    ...
    -- Quit xmonad
    , ((modm .|. shiftMask, xK_q     ), spawn "~/.config/scripts/powermenu.sh")

    -- Restart xmonad
    , ((modm              , xK_q     ), spawn "xmonad --recompile; xmonad --restart")

    -- Run xmessage with a summary of the default keybindings (useful for beginners)
    , ((modm .|. shiftMask, xK_f ), spawn "rofi -modi \"help:~/.config/scripts/help.sh\" -show help -theme ~/.config/rofi/launcher/style.rasi")
    ]
    ++
